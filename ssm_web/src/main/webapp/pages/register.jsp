                                ...
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-12 mb-20">
                                            ...
                                            <input name="username" class="mb-0" type="text" placeholder="Name">
                                        </div>
                                        <div class="col-md-12 mb-20">
                                            <label>telephone*</label>
                                            <input name="tel_num" class="mb-0" type="tel_num" placeholder="Telephone">
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-10">
                                            <h4>${tel_NumPromptText}</h4>
                                        </div>
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary" title="注册">
