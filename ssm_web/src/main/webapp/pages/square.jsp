                    ...
                    <ul>
                        ...
                        <li>
                            <div class="product-details-left pt-60" >
                                ...
                                <div class="product-details-thumbs slider-thumbs-1">
                                    <p style="height: 5px;float:left;color: black;">${st}</p>
                                    <p style="height: 5px;float:left">豪华发烧型</p>
                                    <p style="height: 5px;float:left">总价：<em style="color: black;">#</em></p>
                                </div>

                                <div class="product-details-thumbs slider-thumbs-1">
                                    <div class="sm-image"><img src="${st}" alt="product image thumb"></div>
                        ...
                        <c:forEach begin="0" end ="${graphics_list.size()-1}" var="num">
                            ...
                            <div class="product-details-left pt-60" >
                                <h6>用户自定义标题</h6>
                                <div class="product-details-thumbs slider-thumbs-1">
                                    <p style="height: 5px;float:left;color: black;">abc</p>
                                    <p style="height: 5px;float:left">豪华发烧型</p>
                                    <p style="height: 5px;float:left">总价：<em style="color: black;">#</em></p>
                                </div>
