    ...
    <script type="text/javascript">
        $(function () {
            $("#hup a").click(function () {
                var keyboardid = this.id;
                var keyboard_id=keyboardid;
                // alert("monitor"+monitorid)
                sessionStorage.setItem("hardware",keyboardid);//将选择的硬件放入session中
                var keyboardimg=$("#"+keyboardid).attr("keyboardimg");
                var keyboardprice=$("#"+keyboardid).attr("keyboardprice");
                var keyboardname=$("#"+keyboardid).attr("keyboardname");


                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/keyboard/searchIfExistKeyboard.do",
                    data:{keyboard_id:keyboard_id
                    },
                    dataType:"json",
                    success:function(data){
                        if(data.flag=="ok"){
                            ...
                            $('#content').append(' <li>\n' +
                                ...
                                '                <img src='+keyboardimg+' alt="cart products">\n' +
                                '                </a>\n' +
                                '                <div class="minicart-product-details">\n' +
                                '                <h6><a href="product-details-right-sidebar.html">'+keyboardname+'</a></h6>\n' +
                                '            <span>'+keyboardprice+'</span>\n' +
                                '            </div>\n' +
                                                ...
                                                <div class="single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="single-product.html">
                                                            <img src="${item.keyboard_img}" alt="Li's Product Image">
                                                        </a>
                                                        ...
                                                        <div class="product_desc_info">
                                                            <div class="product-review">
                                                                <h5 class="manufacturer">
                                                                    <a href="http://demo.hasthemes.com/limupa-v1/limupa/product-details.html">${item.keyboard_brand}</a>
                                                                </h5>
                                                            ...
                                                            <h4><a class="product_name" href="${item.keyboard_url}">${item.keyboard_name}</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">${item.keyboard_price}</span>
                                                            </div>
                                                        </div>
                                                        <div class="add-actions" id="hup">
                                                            <ul class="add-actions-link">
                                                                <li class="add-cart active">
                                                                    <a href="#" id="${item.keyboard_id}"  keyboardprice="${item.keyboard_price}" keyboardname="${item.keyboard_name}" keyboardimg="${item.keyboard_img}">加入配置单</a>
                                                                    ...
                                                                    <%--</li>--%>
                                                                <li>
                                                                    <button title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModal"  data-img="${item.keyboard_img}" data-name="${item.keyboard_name}" data-brand="${item.keyboard_brand}" data-position="${item.keyboard_position}" data-linkmethod="${item.keyboard_linkMethod}" data-inter="${item.keyboard_inter}" data-price="${item.keyboard_price}" data-keymethod="${item.keyboard_keyMethod}"><i class="fa fa-eye"></i></button>
                                                                </li>
                                                                <li>
                                                                    <input  type="hidden" id="${item.keyboard_id}" value="${item.keyboard_img}">
                                                ...
                                                <div class="col-lg-5 col-md-7">
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            ...
                                                            <h4><a class="product_name" href="single-product.html">"${item.keyboard_name}"</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">"${item.keyboard_price}"</span>
                                                            </div>
                                                            <p> 键盘定位: "${item.keyboard_position}"</p>
                                                            <p> 键盘连接方式: "${item.keyboard_linkMethod}"</p>
                                                            <p> 键盘接口: "${item.keyboard_inter}"</p>
                                                            <p> 键盘按键技术: "${item.keyboard_keyMethod}"</p>
                                                            <a href="${item.keyboard_url}">购买链接</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul class="pagination-box pt-xs-20 pb-xs-15">
                                            <li><a href="${pageContext.request.contextPath}/keyboard/findAllKeyboardInformation.do?page=${pageInfo.pageNum-1}&size=9" class="Previous"><i class="fa fa-chevron-left"></i> Previous</a>
                                            </li>

                                            <c:forEach  begin="1" end="${pageInfo.pages}" var="PageNum">
                                                <li><a href="${pageContext.request.contextPath}/keyboard/findAllKeyboardInformation.do?page=${PageNum}&size=9">${PageNum}</a></li>
                                            </c:forEach>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/keyboard/findAllKeyboardInformation.do?page=${pageInfo.pageNum+1}&size=9" class="Next"> Next <i class="fa fa-chevron-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="sidebar-categores-box">
                    ...
                    <div class="filter-sub-area">
                        ...
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">Vortexgear</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">双飞燕</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">雷柏</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">海盗船</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">血手幽灵</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">钛度</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">达尔优</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="filter-sub-area pt-sm-10 pt-xs-10">
                        ...
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">50元以下</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">50-99元</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">100-199元</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">200-399元</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">400-599元</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">600-899元</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">900元以上</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    ...
                    <!-- filter-sub-area start -->
                    <div class="filter-sub-area pt-sm-10 pt-xs-10">
                        <h5 class="filter-sub-titel">产品定位</h5>
                        <div class="size-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">机械键盘</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">游戏键盘</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">超薄键盘</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">平板键盘</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">多功能键盘</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">经济实用键盘</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">数字键盘</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                        <h5 class="filter-sub-titel">连接方式</h5>
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">有线</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">无线</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">蓝牙</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    ...
                    <!-- filter-sub-area start -->
                    <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                        <h5 class="filter-sub-titel">键盘接口</h5>
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">USB接口</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">PS/2接口</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">USB+PS/2双接口</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                        <h5 class="filter-sub-titel">按键技术</h5>
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">黑轴</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">红轴</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">茶轴</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">青轴</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">白轴</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">凯华轴</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">雷柏轴</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">Razer轴</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">X架构</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">火山口架构</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images slider-navigation-1">
                                ...
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="lg-image">
                                        <img src="${item.keyboard_img}" alt="product image">
                                    </div>
                                </c:forEach>
                            ...
                            <div class="product-details-thumbs slider-thumbs-1">
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="sm-image"><img src="${item.keyboard_img}" alt="product image thumb"></div>
                                </c:forEach>
                            </div>
                        </div>
                        <!--// Product Details Left -->
                ...
                <form>
                    <div class="form-group">
                        ...
                        <div class="product-details-right" style="float: left; margin-left:48px ">
                            <p>
                                <em id="modal_keyboard_name" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                品牌：
                                <em id="modal_keyboard_brand" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                键盘定位：
                                <em id="modal_keyboard_position" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                键盘连接方式：
                                <em id="modal_keyboard_linkmethod" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                键盘接口：
                                <em id="modal_keyboard_inter" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                价格：
                                <em id="modal_keyboard_price" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                键盘按键技术：
                                <em id="modal_keyboard_keymethod" style="color: #0b0b0b"></em>
                            </p>
                        </div>
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var linkmethod=button.data('linkmethod');
        var inter=button.data('inter');
        var price=button.data('price');
        var keymethod=button.data('keymethod');

        document.getElementById("modal_keyboard_name").innerHTML=name;
        document.getElementById("modal_keyboard_brand").innerHTML=brand;
        document.getElementById("modal_keyboard_position").innerHTML=position;
        document.getElementById("modal_keyboard_linkmethod").innerHTML=linkmethod;
        document.getElementById("modal_keyboard_inter").innerHTML=inter;
        document.getElementById("modal_keyboard_price").innerHTML=price;
        document.getElementById("modal_keyboard_keymethod").innerHTML=keymethod;
