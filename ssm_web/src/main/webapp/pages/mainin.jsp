                            ...
                            <ul class="ht-menu">
                                ...
                                <li>
                                    ...
                                    <div class="ht-currency-trigger">
                                        <button type="button" class="btn btn-primary" title="登录"
                                                onclick="location.href='${pageContext.request.contextPath}/user/tologin.do'">
                                            <i class="fa fa-refresh"></i> 登录
                                        </button>
                                        <button type="button" class="btn btn-primary" title="注册"
                                                onclick="location.href='${pageContext.request.contextPath}/user/toRegister.do'">
        ...
        <span class="cart-item-count">2</span>
                                    ...
                                    <div class="minicart">
                                        ...
                                        <div class="minicart-button">
                                            <a href="http://demo.hasthemes.com/limupa-v1/limupa/shopping.html"
                        ...
                        <div class="hb-menu">
                            <nav>
                                <ul>
                                    ...
                                    <li > <a  href="${pageContext.request.contextPath}/pagesu.jsp" >cpu</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/motherboard.jsp" >主板</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/harddisk.jsp" >硬盘</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/ssd.jsp" >固态硬盘</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/graphics.jsp" >显卡</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/soundcard.jsp" >声卡</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/netcard.jsp" >网卡</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/monitor.jsp" >显示器</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/power.jsp" >电源</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/mouse.jsp" >鼠标</a><li>
                                    <li><a href="${pageContext.request.contextPath}/pages/keyboard.jsp" >键盘</a></li>
                                    <%--<li class="dropdown-holder"><a href="index.html">CPU</a>--%>
                                        <%--<ul class="hb-dropdown">--%>
                                            <%--<li><a href="index.html">服务器CPU</a></li>--%>
                                            <%--<li><a href="index-2.html">CPU</a></li>--%>
                                        <%--</ul>--%>
                                    <%--</li>--%>
                                    <%--<li>--%>
                                        <%--<button type="button" onclick="createRequest('cpu.jsp','show');return false;">--%>
                                            <%--cpu--%>
                                        <%--</button>--%>
                                    <%--</li>--%>
                                    <%--<li>--%>
                                        <%--<button type="button" onclick="createRequest('mouse.jsp','show');return false;">--%>
                                            <%--mouse--%>
                                        <%--</button>--%>
                                    <%--</li>--%>
                                    <%--<li><button type="button" onclick="createRequest('harddisk.jsp','show');return false;">--%>
                                        <%--硬盘--%>
                                    <%--</button>--%>
                                    <%--</li>--%>
                                    <%--<li><a href="shop-left-sidebar.html">固态硬盘</a></li>--%>
                                    <%--<li><a href="shop-left-sidebar.html">显卡</a></li>--%>
                                    <%--<li><a href="shop-left-sidebar.html">声卡</a></li>--%>
                                    <%--<li><a href="shop-left-sidebar.html">网卡</a></li>--%>
                                    <%--<li><a href="shop-left-sidebar.html">显示器</a></li>--%>
                                    <%--<li><a href="shop-left-sidebar.html">电源</a></li>--%>
                                    <%--<li><a href="shop-left-sidebar.html">鼠标</a></li>--%>
                                    <%--<li><a href="shop-left-sidebar.html">键盘</a></li>--%>
                                                    ...
                                                    <div class="product_desc_info">
                                                        <div class="product-review">
                                                            <h5 class="manufacturer">
                                                                <a href="http://demo.hasthemes.com/limupa-v1/limupa/product-details.html">Graphic
                                                                    Corner</a>
                                                            </h5>
