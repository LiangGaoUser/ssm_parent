...
<div class="body-wrapper">
    ...
    <div class="page-section mb-30">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30">
                    <!-- Login Form s-->
                    <form action="${pageContext.request.contextPath}/user/newlogin.do"  method="post">
                        <div class="login-form">
                            <h4 class="login-title">Login</h4>
                            <div class="row">
                                <div class="col-md-12 col-12 mb-20">
                                    <label>telephone*</label>
                                    <input name="tel_num" class="mb-0" type="tel" placeholder="Email Address">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <%--<input type="text" class="form-control" name="promptText" disabled="disabled"--%>
                                           <%--placeholder="登录提示" value="${promptText1}">--%>
                                    <h4>${promptText1}</h4>
                                </div>
                                <div class="col-md-12">
