    ...
    <script type="text/javascript">
        $(function () {
            $("#hup a").click(function () {
                var harddiskid = this.id;
                var hardDisk_id=harddiskid;
                sessionStorage.setItem("hardware",harddiskid);//将选择的硬件放入session中
                var hardDiskimg=$("#"+harddiskid).attr("hardDiskimg");
                var hardDiskprice=$("#"+harddiskid).attr("hardDiskprice");
                var hardDiskname=$("#"+harddiskid).attr("hardDiskname");

                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/HardDisk/searchIfExistHardDisk.do",
                    data:{hardDisk_id:hardDisk_id
                    },
                    dataType:"json",
                    success:function(data){
                        if(data.flag=="ok"){
                            ...
                            $('#content').append(' <li>\n' +
                                ...
                                '                <img src='+hardDiskimg+' alt="cart products">\n' +
                                '                </a>\n' +
                                '                <div class="minicart-product-details">\n' +
                                '                <h6><a href="product-details-right-sidebar.html">'+hardDiskname+'</a></h6>\n' +
                                '            <span>'+hardDiskprice+'</span>\n' +
                                '            </div>\n' +
                                                        ...
                                                        <div class="add-actions" id="hup">
                                                            <ul class="add-actions-link">
                                                                <li class="add-cart active">
                                                                    <a href="#" id="${item.hardDisk_id}"  hardDiskprice="${item.hardDisk_price}" hardDiskname="${item.hardDisk_name}" hardDiskimg="${item.hardDisk_img}">加入配置单</a>
                                                                    ...
                                                                    <%--</li>--%>
                                                                <li>
                                                                    <button title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModal"  data-img="${item.hardDisk_img}" data-name="${item.hardDisk_name}" data-brand="${item.hardDisk_brand}" data-capacity="${item.hardDisk_capacity}" data-interkind="${item.hardDisk_interKind}" data-speed="${item.hardDisk_speed}" data-price="${item.hardDisk_price}" data-cache="${item.hardDisk_cache}"><i class="fa fa-eye"></i></button>
                                                                </li>
                                                                <li>
                                                ...
                                                <div class="col-lg-5 col-md-7">
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            ...
                                                            <p> 硬盘品牌: "${item.hardDisk_brand}"</p>
                                                            <p> 适用类型: "${item.hardDisk_useKind}"</p>
                                                            <p> 硬盘容量: "${item.hardDisk_capacity}"</p>
                                                            <p> 硬盘缓存: "${item.hardDisk_cache}"</p>
                                                            <a href="${item.hardDisk_url}">购买链接</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul class="pagination-box pt-xs-20 pb-xs-15">
                                            <li><a href="${pageContext.request.contextPath}/HardDisk/findAllHardDiskInformation.do?page=${pageInfo.pageNum-1}&size=9" class="Previous"><i class="fa fa-chevron-left"></i> Previous</a>
                                            </li>

                                            <c:forEach  begin="1" end="${pageInfo.pages}" var="PageNum">
                                                <li><a href="${pageContext.request.contextPath}/HardDisk/findAllHardDiskInformation.do?page=${PageNum}&size=9">${PageNum}</a></li>
                                            </c:forEach>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/HardDisk/findAllHardDiskInformation.do?page=${pageInfo.pageNum+1}&size=9" class="Next"> Next <i class="fa fa-chevron-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="sidebar-categores-box">
                        ...
                        <div class="filter-sub-area">
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">西部数据</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">希捷</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">东芝</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">HGST</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="filter-sub-area pt-sm-10 pt-xs-10">
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">400元以下</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">400-600元</a></li>
                        ...
                        <!-- filter-sub-area start -->
                        <div class="filter-sub-area pt-sm-10 pt-xs-10">
                            <h5 class="filter-sub-titel">硬盘容量</h5>
                            <div class="size-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">10TB及以上</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">8TB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">6TB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">4TB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">3TB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">2TB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">1TB及以下</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        ...
                                        <li><input type="checkbox" name="product-size"><a href="#">64MB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">32MB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">16MB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">8MB</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <!-- filter-sub-area start -->
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">转速</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">10000转</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">7200转</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">5900转</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">5400转</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">接口类型</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">SATA3.0</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">SATA2.0</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">SAS</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images slider-navigation-1">
                                ...
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="lg-image">
                                        <img src="${item.hardDisk_img}" alt="product image">
                                    </div>
                                </c:forEach>
                            ...
                            <div class="product-details-thumbs slider-thumbs-1">
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="sm-image"><img src="${item.hardDisk_img}" alt="product image thumb"></div>
                                </c:forEach>
                            </div>
                        </div>
                        <!--// Product Details Left -->
                ...
                <form>
                    <div class="form-group">
                        ...
                        <div class="product-details-right" style="float: left; margin-left:48px ">
                            <p>
                                <em id="modal_HD_name" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                品牌：
                                <em id="modal_HD_brand" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                硬盘容量：
                                <em id="modal_HD_capacity" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                接口类型：
                                <em id="modal_HD_interkind" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                接口转速：
                                <em id="modal_HD_speed" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                价格：
                                <em id="modal_HD_price" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                硬盘缓存：
                                <em id="modal_HD_cache" style="color: #0b0b0b"></em>
                            </p>
                        </div>
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        document.getElementById("modal_HD_name").innerHTML=name;
        document.getElementById("modal_HD_brand").innerHTML=brand;
        document.getElementById("modal_HD_capacity").innerHTML=capacity;
        document.getElementById("modal_HD_interkind").innerHTML=interkind;
        document.getElementById("modal_HD_speed").innerHTML=speed;
        document.getElementById("modal_HD_price").innerHTML=price;
        document.getElementById("modal_HD_cache").innerHTML=cache;
