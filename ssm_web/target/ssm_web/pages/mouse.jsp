    ...
    <script type="text/javascript">
        $(function () {
            $("#hup a").click(function () {
                var mouseid = this.id;
                var mouse_id=mouseid;
                // alert("monitor"+monitorid)
                sessionStorage.setItem("hardware",mouseid);//将选择的硬件放入session中
                var mouseimg=$("#"+mouseid).attr("mouseimg");
                var mouseprice=$("#"+mouseid).attr("mouseprice");
                var mousename=$("#"+mouseid).attr("mousename");


                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/mouse/searchIfExistMouse.do",
                    ...
                    success:function(data){
                        if(data.flag=="ok"){
                            ...
                            $('#content').append(' <li>\n' +
                                ...
                                '                <img src='+mouseimg+' alt="cart products">\n' +
                                '                </a>\n' +
                                '                <div class="minicart-product-details">\n' +
                                '                <h6><a href="product-details-right-sidebar.html">'+mousename+'</a></h6>\n' +
                                '            <span>'+mouseprice+'</span>\n' +
                                '            </div>\n' +
                                                ...
                                                <div class="single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="single-product.html">
                                                            <img src="${item.mouse_img}" alt="Li's Product Image">
                                                        </a>
                                                        ...
                                                        <div class="product_desc_info">
                                                            <div class="product-review">
                                                                <h5 class="manufacturer">
                                                                    <a href="http://demo.hasthemes.com/limupa-v1/limupa/product-details.html">${item.mouse_brand}</a>
                                                                </h5>
                                                            ...
                                                            <h4><a class="product_name" href="${item.mouse_url}">${item.mouse_name}</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">${item.mouse_price}</span>
                                                            </div>
                                                        </div>
                                                        <div class="add-actions" id="hup">
                                                            <ul class="add-actions-link">
                                                                <li class="add-cart active">
                                                                    <a href="#" id="${item.mouse_id}"  mouseprice="${item.mouse_price}" mousename="${item.mouse_name}" mouseimg="${item.mouse_img}">加入配置单</a>
                                                                    ...
                                                                    <%--</li>--%>
                                                                <li>
                                                                    <button title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModal"  data-img="${item.mouse_img}" data-name="${item.mouse_name}" data-brand="${item.mouse_brand}" data-approtype="${item.mouse_approType}" data-linkmethod="${item.mouse_linkMethod}" data-inter="${item.mouse_inter}" data-price="${item.mouse_price}" data-workmethod="${item.mouse_workMethod}"><i class="fa fa-eye"></i></button>
                                                                </li>
                                                                <li>
                                                                    <input  type="hidden" id="${item.mouse_id}" value="${item.mouse_img}">
                                                ...
                                                <div class="col-lg-5 col-md-7">
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            ...
                                                            <h4><a class="product_name" href="single-product.html">"${item.mouse_name}"</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">"${item.mouse_price}"</span>
                                                            </div>
                                                            <p> 鼠标适用类型: "${item.mouse_approType}"</p>
                                                            <p> 鼠标连接方式: "${item.mouse_linkMethod}"</p>
                                                            <p> 鼠标工作方式: "${item.mouse_workMethod}"</p>
                                                            <p> 鼠标接口: "${item.mouse_inter}"</p>
                                                            <a href="${item.mouse_url}">购买链接</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul class="pagination-box pt-xs-20 pb-xs-15">
                                            <li><a href="${pageContext.request.contextPath}/mouse/findAllMouseInformation.do?page=${pageInfo.pageNum-1}&size=9" class="Previous"><i class="fa fa-chevron-left"></i> Previous</a>
                                            </li>

                                            <c:forEach  begin="1" end="${pageInfo.pages}" var="PageNum">
                                                <li><a href="${pageContext.request.contextPath}/mouse/findAllMouseInformation.do?page=${PageNum}&size=9">${PageNum}</a></li>
                                            </c:forEach>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/mouse/findAllMouseInformation.do?page=${pageInfo.pageNum+1}&size=9" class="Next"> Next <i class="fa fa-chevron-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="sidebar-categores-box">
                        ...
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    ...
                                    <li><input type="checkbox" name="product-size"><a href="#">富勒</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">红火牛</a></li>
                    ...
                    <div class="filter-sub-area pt-sm-10 pt-xs-10">
                        ...
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">39元以下</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">40-59元</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">60-99元</a></li>
                                    ...
                                    <li><input type="checkbox" name="product-size"><a href="#">400元以上</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="filter-sub-area pt-sm-10 pt-xs-10">
                        ...
                        <div class="size-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">竞技游戏</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">商务舒适</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">经济实用</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">移动便携</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">时尚个性</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    ...
                                    <li><input type="checkbox" name="product-size"><a href="#">多连</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">双模式（有线+无线）</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    ...
                    <!-- filter-sub-area start -->
                    <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                        <h5 class="filter-sub-titel">鼠标接口</h5>
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                    ...
                    <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                        <h5 class="filter-sub-titel">工作方式</h5>
                        <div class="categori-checkbox">
                            <form action="#">
                                <ul>
                                    <li><input type="checkbox" name="product-size"><a href="#">激光</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">光电</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">蓝光</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">针光</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">无孔</a></li>
                                    <li><input type="checkbox" name="product-size"><a href="#">蓝影</a></li>
                                </ul>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images slider-navigation-1">
                                ...
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="lg-image">
                                        <img src="${item.mouse_img}" alt="product image">
                                    </div>
                                </c:forEach>
                            ...
                            <div class="product-details-thumbs slider-thumbs-1">
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="sm-image"><img src="${item.mouse_img}" alt="product image thumb"></div>
                                </c:forEach>
                            </div>
                        </div>
                        <!--// Product Details Left -->
                ...
                <form>
                    <div class="form-group">
                        ...
                        <div class="product-details-right" style="float: left; margin-left:48px ">
                            <p>
                                <em id="modal_mouse_name" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                品牌：
                                <em id="modal_mouse_brand" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                鼠标适用类型：
                                <em id="modal_mouse_approtype" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                鼠标连接方式：
                                <em id="modal_mouse_linkmethod" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                鼠标工作方式：
                                <em id="modal_mouse_workmethod" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                价格：
                                <em id="modal_mouse_price" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                鼠标接口：
                                <em id="modal_mouse_inter" style="color: #0b0b0b"></em>
                            </p>
                        </div>
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var workmethod=button.data('workmethod');
        var linkmethod=button.data('linkmethod');
        var price=button.data('price');
        var inter=button.data('inter');

        document.getElementById("modal_mouse_name").innerHTML=name;
        document.getElementById("modal_mouse_brand").innerHTML=brand;
        document.getElementById("modal_mouse_approtype").innerHTML=approtype;
        document.getElementById("modal_mouse_linkmethod").innerHTML=linkmethod;
        document.getElementById("modal_mouse_workmethod").innerHTML=workmethod;
        document.getElementById("modal_mouse_price").innerHTML=price;
        document.getElementById("modal_mouse_inter").innerHTML=inter;
