    ...
    <script type="text/javascript">
        $(function () {
            $("#hup a").click(function () {
                var powerid = this.id;
                var power_id=powerid;
                // alert("monitor"+monitorid)
                sessionStorage.setItem("hardware",powerid);//将选择的硬件放入session中
                var powerimg=$("#"+powerid).attr("powerimg");
                var powerprice=$("#"+powerid).attr("powerprice");
                var powername=$("#"+powerid).attr("powername");


                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/power/searchIfExistPower.do",
                    ...
                    success:function(data){
                        if(data.flag=="ok"){
                            ...
                            $('#content').append(' <li>\n' +
                                ...
                                '                <img src='+powerimg+' alt="cart products">\n' +
                                '                </a>\n' +
                                '                <div class="minicart-product-details">\n' +
                                '                <h6><a href="product-details-right-sidebar.html">'+powername+'</a></h6>\n' +
                                                ...
                                                <div class="single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="single-product.html">
                                                            <img src="${item.power_img}" alt="Li's Product Image">
                                                        </a>
                                                        ...
                                                        <div class="product_desc_info">
                                                            <div class="product-review">
                                                                <h5 class="manufacturer">
                                                                    <a href="http://demo.hasthemes.com/limupa-v1/limupa/product-details.html">${item.power_brand}</a>
                                                                </h5>
                                                            ...
                                                            <h4><a class="product_name" href="${item.power_url}">${item.power_name}</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">${item.power_price}</span>
                                                            </div>
                                                        </div>
                                                        <div class="add-actions" id="hup">
                                                            <ul class="add-actions-link">
                                                                <li class="add-cart active">
                                                                    <a href="#" id="${item.power_id}"  powerprice="${item.power_price}" powername="${item.power_name}" powerimg="${item.power_img}">加入配置单</a>
                                                                    ...
                                                                    <%--</li>--%>
                                                                <li>
                                                                    <button title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModal"  data-img="${item.power_img}" data-name="${item.power_name}" data-brand="${item.power_brand}" data-ratepower="${item.power_ratePower}" data-outlinetype="${item.power_outlineType}" data-price="${item.power_price}" data-kind="${item.power_kind}"><i class="fa fa-eye"></i></button>
                                                                </li>
                                                                <li>
                                                                    <input  type="hidden" id="${item.power_id}" value="${item.power_img}">
                                                ...
                                                <div class="col-lg-5 col-md-7">
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            ...
                                                            <h4><a class="product_name" href="single-product.html">"${item.power_name}"</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">"${item.power_price}"</span>
                                                            </div>
                                                            <p> 电源品牌: "${item.power_brand}"</p>
                                                            <p> 电源额定功率: "${item.power_ratePower}"</p>
                                                            <p> 电源出线类型: "${item.power_outlineType}"</p>
                                                            <p> 电源类型: "${item.power_kind}"</p>
                                                            <a href="${item.power_url}">购买链接</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul class="pagination-box pt-xs-20 pb-xs-15">
                                            <li><a href="${pageContext.request.contextPath}/power/findAllPowerInformation.do?page=${pageInfo.pageNum-1}&size=9" class="Previous"><i class="fa fa-chevron-left"></i> Previous</a>
                                            </li>

                                            <c:forEach  begin="1" end="${pageInfo.pages}" var="PageNum">
                                                <li><a href="${pageContext.request.contextPath}/power/findAllPowerInformation.do?page=${PageNum}&size=9">${PageNum}</a></li>
                                            </c:forEach>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/power/findAllPowerInformation.do?page=${pageInfo.pageNum+1}&size=9" class="Next"> Next <i class="fa fa-chevron-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="sidebar-categores-box">
                        ...
                        <div class="filter-sub-area">
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">航嘉</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">鑫谷</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">aigo</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金河田</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">先马</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">长城机电</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">至睿</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        ...
                                        <li><input type="checkbox" name="product-size"><a href="#">300-600元</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">600-1000元</a></li>
                        ...
                        <!-- filter-sub-area start -->
                        <div class="filter-sub-area pt-sm-10 pt-xs-10">
                            <h5 class="filter-sub-titel">额定功率</h5>
                            <div class="size-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">300W及以下</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">301W-350W</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">351W-400W</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">401W-450W</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">451W-500W</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">501W-600W</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">601W-800W</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">801W-1000W</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">1001W及以上</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">出线类型</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">模组电源</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">半模组电源</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">非模组电源</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <!-- filter-sub-area start -->
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">电源类型</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">台式机电源</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">游戏电源</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">小机箱电源</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">服务器电源</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">80PLUS认证</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">钛金牌</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">白金牌</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金牌</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">银牌</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">铜牌</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">白牌</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                ...
                <form>
                    <div class="form-group">
                        ...
                        <div class="product-details-right" style="float: left; margin-left:48px ">
                            <p>
                                <em id="modal_power_name" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                品牌：
                                <em id="modal_power_brand" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                电源额定功率：
                                <em id="modal_power_ratepower" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                电源出线类型：
                                <em id="modal_power_outlinetype" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                电源类型：
                                <em id="modal_power_kind" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                价格：
                                <em id="modal_power_price" style="color: #0b0b0b"></em>
                            </p>
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var ratepower=button.data('ratepower');
        var outlinetype=button.data('outlinetype');
        var kind=button.data('kind');
        var price=button.data('price');


        document.getElementById("modal_power_name").innerHTML=name;
        document.getElementById("modal_power_brand").innerHTML=brand;
        document.getElementById("modal_power_ratepower").innerHTML=ratepower;
        document.getElementById("modal_power_outlinetype").innerHTML=outlinetype;
        document.getElementById("modal_power_kind").innerHTML=kind;
        document.getElementById("modal_power_price").innerHTML=price;
