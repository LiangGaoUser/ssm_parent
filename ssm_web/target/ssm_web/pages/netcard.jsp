...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            $("#hup a").click(function () {
                var netcardid = this.id;
                var netcard_id=netcardid;
                sessionStorage.setItem("hardware",netcardid);//将选择的硬件放入session中
                var netcardimg=$("#"+netcardid).attr("netcardimg");
                var netcardprice=$("#"+netcardid).attr("netcardprice");
                var netcardname=$("#"+netcardid).attr("netcardname");


                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/NetCard/searchIfExistNetCard.do",
                    data:{netcard_id:netcard_id
                    },
                    dataType:"json",
                    success:function(data){
                        if(data.flag=="ok"){
                            ...
                            $('#content').append(' <li>\n' +
                                ...
                                '                <img src='+netcardimg+' alt="cart products">\n' +
                                '                </a>\n' +
                                '                <div class="minicart-product-details">\n' +
                                '                <h6><a href="product-details-right-sidebar.html">'+netcardname+'</a></h6>\n' +
                                '            <span>'+netcardprice+'</span>\n' +
                                '            </div>\n' +
    ...
    <%-- tel_num:tel_num,cpu_id:cpu_id, netcard_id:netcard_id, harddisk_id:harddisk_id, keyboard_id:keyboard_id,
                                                ...
                                                <div class="single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="single-product.html">
                                                            <img src="${item.netcard_img}" alt="Li's Product Image">
                                                        </a>
                                                        ...
                                                        <div class="product_desc_info">
                                                            <div class="product-review">
                                                                <h5 class="manufacturer">
                                                                    <a href="http://demo.hasthemes.com/limupa-v1/limupa/product-details.html">${item.netcard_brand}</a>
                                                                </h5>
                                                            ...
                                                            <h4><a class="product_name" href="${item.netcard_url}">${item.netcard_name}</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">${item.netcard_price}</span>
                                                            </div>
                                                        </div>
                                                        <div class="add-actions" id="hup">
                                                            <ul class="add-actions-link">
                                                                <li class="add-cart active">
                                                                    <a href="#" id="${item.netcard_id}"  netcardprice="${item.netcard_price}" netcardname="${item.netcard_name}" netcardimg="${item.netcard_img}">加入配置单</a>
                                                                    ...
                                                                    <%--</li>--%>
                                                                <li>
                                                                    <button title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModal"  data-img="${item.netcard_img}" data-name="${item.netcard_name}" data-brand="${item.netcard_brand}" data-nettype="${item.netcard_netType}" data-netintertype="${item.netcard_netInterType}" data-price="${item.netcard_price}" data-pcikind="${item.netcard_pciKind}"><i class="fa fa-eye"></i></button>
                                                                </li>
                                                                <li>
                                                                    <input  type="hidden" id="${item.netcard_id}" value="${item.netcard_img}">
                                                ...
                                                <div class="col-lg-5 col-md-7">
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            ...
                                                            <h4><a class="product_name" href="single-product.html">"${item.netcard_name}"</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">"${item.netcard_price}"</span>
                                                            </div>
                                                            <p> 网卡品牌: "${item.netcard_brand}"</p>
                                                            <p> 网卡使用网络类型: "${item.netcard_netType}"</p>
                                                            <p> 网卡接口类型: "${item.netcard_netInterType}"</p>
                                                            <p> 网卡传输速率: "${item.netcard_pciKind}"</p>
                                                            <a href="${item.netcard_url}">购买链接</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul class="pagination-box pt-xs-20 pb-xs-15">
                                            <li><a href="${pageContext.request.contextPath}/NetCard/findAllNetCardInformation.do?page=${pageInfo.pageNum-1}&size=9" class="Previous"><i class="fa fa-chevron-left"></i> Previous</a>
                                            </li>

                                            <c:forEach  begin="1" end="${pageInfo.pages}" var="PageNum">
                                                <li><a href="${pageContext.request.contextPath}/NetCard/findAllNetCardInformation.do?page=${PageNum}&size=9">${PageNum}</a></li>
                                            </c:forEach>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/NetCard/findAllNetCardInformation.do?page=${pageInfo.pageNum+1}&size=9" class="Next"> Next <i class="fa fa-chevron-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="sidebar-categores-box">
                        ...
                        <div class="filter-sub-area">
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">Winyao</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">Intel</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">TP-LINK</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">光润通</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">DIEWU</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">LR-Link</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">D-Link</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        ...
                                        <li><input type="checkbox" name="product-size"><a href="#">50-100元</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">100-400元</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">400-1000元</a></li>
                        ...
                        <!-- filter-sub-area start -->
                        <div class="filter-sub-area pt-sm-10 pt-xs-10">
                            <h5 class="filter-sub-titel">使用网络类型</h5>
                            <div class="size-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">以太网</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">快速以太网</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">千兆以太网</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">万兆以太网</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">网络接口类型</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">RJ45接口</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">光纤接口</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">传输速率</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">10/100Mbps</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">10/100/1000Mbps</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">1000Mbps</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">10000Mbps</a></li>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images slider-navigation-1">
                                ...
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="lg-image">
                                        <img src="${item.netcard_img}" alt="product image">
                                    </div>
                                </c:forEach>
                            ...
                            <div class="product-details-thumbs slider-thumbs-1">
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="sm-image"><img src="${item.netcard_img}" alt="product image thumb"></div>
                                </c:forEach>
                            </div>
                        </div>
                        <!--// Product Details Left -->
                ...
                <form>
                    <div class="form-group">
                        ...
                        <div class="product-details-right" style="float: left; margin-left:48px ">
                            <p>
                                网卡品牌：
                                <em id="modal_netcard_brand" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                网卡名称：
                                <em id="modal_netcard_name" style="..."></em>
                            </p>
                            <p>
                                网卡适用网络类型：
                                <em id="modal_netcard_netType" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                网卡接口类型：
                                <em id="modal_netcard_netInterType" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                网卡总线类型：
                                <em id="modal_netcard_pciKind" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                网卡价格：
                                <em id="modal_netcard_price" style="color: #0b0b0b"></em>
                            </p>
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var nettype=button.data('nettype');
        var netintertype=button.data('netintertype');
        var pcikind=button.data('pcikind');
        var price=button.data('price');

        document.getElementById("modal_netcard_name").innerHTML=name;
        document.getElementById("modal_netcard_brand").innerHTML=brand;
        document.getElementById("modal_netcard_netType").innerHTML=nettype;
        document.getElementById("modal_netcard_netInterType").innerHTML=netintertype;
        document.getElementById("modal_netcard_pciKind").innerHTML=pcikind;
        document.getElementById("modal_netcard_price").innerHTML=price;
