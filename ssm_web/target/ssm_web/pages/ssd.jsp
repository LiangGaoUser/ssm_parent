    ...
    <script type="text/javascript">
        $(function () {
            $("#hup a").click(function () {
                ...
                sessionStorage.setItem("hardware",ssdid);//将选择的硬件放入session中
                var ssdimg=$("#"+ssdid).attr("ssdimg");
                var ssdprice=$("#"+ssdid).attr("ssdprice");
                var ssdname=$("#"+ssdid).attr("ssdname");
                alert(ssdimg+ssdprice+ssdname+"pppppp");
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/Ssd/searchIfExistSsd.do",
                    data:{ssd_id:ssd_id
                    },
                    dataType:"json",
                    success:function(data){
                        if(data.flag=="ok"){
                            $('#content').append(' <li>\n' +
                                ...
                                '                <img src='+ssdimg+' alt="cart products">\n' +
                                '                </a>\n' +
                                '                <div class="minicart-product-details">\n' +
                                '                <h6><a href="product-details-right-sidebar.html">'+ssdname+'</a></h6>\n' +
                                '            <span>'+ssdprice+'</span>\n' +
                                '            </div>\n' +
                                                ...
                                                <div class="single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="single-product.html">
                                                            <img src="${item.ssd_img}" alt="Li's Product Image">
                                                        </a>
                                                        ...
                                                        <div class="product_desc_info">
                                                            <div class="product-review">
                                                                <h5 class="manufacturer">
                                                                    <a href="http://demo.hasthemes.com/limupa-v1/limupa/product-details.html">${item.ssd_brand}</a>
                                                                </h5>
                                                            ...
                                                            <h4><a class="product_name" href="${item.ssd_url}">${item.ssd_name}</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">${item.ssd_price}</span>
                                                            </div>
                                                        </div>
                                                        <div class="add-actions" id="hup">
                                                            <ul class="add-actions-link">
                                                                <li class="add-cart active">
                                                                    <a href="#" id="${item.ssd_id}"  ssdprice="${item.ssd_price}" ssdname="${item.ssd_name}" ssdimg="${item.ssd_img}">加入配置单</a>
                                                                    ...
                                                                    <%--</li>--%>
                                                                <li>
                                                                    <button title="quick view" class="quick-view-btn" data-toggle="modal" data-target="#exampleModal"  data-img="${item.ssd_img}" data-name="${item.ssd_name}" data-brand="${item.ssd_brand}" data-capacity="${item.ssd_capacity}" data-interkind="${item.ssd_inteKind}" data-fma="${item.ssd_fma}" data-price="${item.ssd_price}" data-cache="${item.ssd_cache}"><i class="fa fa-eye"></i></button>
                                                                </li>
                                                                <li>
                                                                    <input  type="hidden" id="${item.ssd_id}" value="${item.ssd_img}">
                                                ...
                                                <div class="col-lg-5 col-md-7">
                                                    <div class="product_desc">
                                                        <div class="product_desc_info">
                                                            ...
                                                            <h4><a class="product_name" href="single-product.html">"${item.ssd_name}"</a></h4>
                                                            <div class="price-box">
                                                                <span class="new-price">"${item.ssd_price}"</span>
                                                            </div>
                                                            <p> 固态硬盘品牌: "${item.ssd_brand}"</p>
                                                            <p> 接口类型: "${item.ssd_inteKind}"</p>
                                                            <p> 硬盘容量: "${item.ssd_capacity}"</p>
                                                            <p> 硬盘缓存: "${item.ssd_cache}"</p>
                                                            <a href="${item.ssd_url}">购买链接</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul class="pagination-box pt-xs-20 pb-xs-15">
                                            <li><a href="${pageContext.request.contextPath}/Ssd/findAllSsdInformation.do?page=${pageInfo.pageNum-1}&size=9" class="Previous"><i class="fa fa-chevron-left"></i> Previous</a>
                                            </li>

                                            <c:forEach  begin="1" end="${pageInfo.pages}" var="PageNum">
                                                <li><a href="${pageContext.request.contextPath}/Ssd/findAllSsdInformation.do?page=${PageNum}&size=9">${PageNum}</a></li>
                                            </c:forEach>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/Ssd/findAllSsdInformation.do?page=${pageInfo.pageNum+1}&size=9" class="Next"> Next <i class="fa fa-chevron-right"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="sidebar-categores-box">
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        ...
                                        <li><input type="checkbox" name="product-size"><a href="#">东芝</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">爱国者</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">海盗船</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">方正</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">超频三</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">创久</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金泰克</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金胜维</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金士顿</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金胜</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金速</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金典</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">骏士</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">金鹏城</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">雷谷</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">美光</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">科赋</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">梅捷</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">闪战</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">威士奇</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">松下</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">七彩虹</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">ROG</a></li>
                        ...
                        <div class="filter-sub-area pt-sm-10 pt-xs-10">
                            ...
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">300元一下</a></li>
                                        ...
                                        <li><input type="checkbox" name="product-size"><a href="#">1000-2000元</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">2000元以上</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <!-- filter-sub-area start -->
                        <div class="filter-sub-area pt-sm-10 pt-xs-10">
                            <h5 class="filter-sub-titel">存储容量</h5>
                            <div class="size-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">1TB以上</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">960GB-1TB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">480GB-512GB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">240GB-256GB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">128GB-240GB</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">闪存架构</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">SATA3接口</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">M.2SATA接口</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">M.2PCle接口</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">Type-C接口</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">MSATA接口</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                        ...
                        <!-- filter-sub-area start -->
                        <div class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15">
                            <h5 class="filter-sub-titel">缓存</h5>
                            <div class="categori-checkbox">
                                <form action="#">
                                    <ul>
                                        <li><input type="checkbox" name="product-size"><a href="#">2GB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">1GB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">512MB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">256MB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">128MB</a></li>
                                        <li><input type="checkbox" name="product-size"><a href="#">无缓存</a></li>
                                    </ul>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images slider-navigation-1">
                                ...
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="lg-image">
                                        <img src="${item.ssd_img}" alt="product image">
                                    </div>
                                </c:forEach>
                            ...
                            <div class="product-details-thumbs slider-thumbs-1">
                                <c:forEach var="item" items="${pageInfo.list}"   step="1" >
                                    <div class="sm-image"><img src="${item.ssd_img}" alt="product image thumb"></div>
                                </c:forEach>
                            </div>
                        </div>
                        <!--// Product Details Left -->
                ...
                <form>
                    <div class="form-group">
                        ...
                        <div class="product-details-right" style="float: left; margin-left:48px ">
                            <p>
                                <em id="modal_ssd_name" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                品牌：
                                <em id="modal_ssd_brand" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                硬盘容量：
                                <em id="modal_ssd_capacity" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                接口类型：
                                <em id="modal_ssd_interkind" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                闪存架构：
                                <em id="modal_ssd_fma" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                价格：
                                <em id="modal_ssd_price" style="color: #0b0b0b"></em>
                            </p>
                            <p>
                                硬盘缓存：
                                <em id="modal_ssd_cache" style="color: #0b0b0b"></em>
                            </p>
                        </div>
...
<script>
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var interkind=button.data('interkind');
        var fma=button.data('fma');
        var price=button.data('price');
        var cache=button.data('cache');

        document.getElementById("modal_ssd_name").innerHTML=name;
        document.getElementById("modal_ssd_brand").innerHTML=brand;
        document.getElementById("modal_ssd_capacity").innerHTML=capacity;
        document.getElementById("modal_ssd_interkind").innerHTML=interkind;
        document.getElementById("modal_ssd_fma").innerHTML=fma;
        document.getElementById("modal_ssd_price").innerHTML=price;
        document.getElementById("modal_ssd_cache").innerHTML=cache;
